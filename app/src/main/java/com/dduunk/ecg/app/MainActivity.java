...
import com.dduunk.ecg.ECGApplication;
...
import com.dduunk.ecg.dfu.DfuProgressFragmentDialog;
import com.dduunk.ecg.dfu.DfuService;
import com.dduunk.ecg.dfu.DfuUpdater;
import com.dduunk.ecg.dfu.ReleasesParser;
import com.dduunk.ecg.models.DfuViewModel;
...
public class MainActivity extends AppCompatActivity implements ScannerFragment.ScannerFragmentListener, PeripheralModulesFragment.PeripheralModulesFragmentListener, DfuProgressFragmentDialog.Listener {
    ...
    protected void onResume() {
        super.onResume();
        ECGApplication.activityResumed();
        checkPermissions();
