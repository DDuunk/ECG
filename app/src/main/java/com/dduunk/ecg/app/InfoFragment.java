...
import com.dduunk.ecg.ble.central.BleUUIDNames;
            ...
            case R.id.action_help:
                if (activity != null) {
                    ...
                    if (fragmentManager != null) {
                        ...
                        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction().replace(R.id.contentLayout, helpFragment, "Help");
